...
def create_vector_database(json_file_path):
    """Create a vector database using ChromaDB with Mistral embeddings."""
    ollama_embeddings = OllamaEmbeddings(model="mistral")  # Updated to use Mistral embeddings
...
def build_chatbot(retriever):
    """Build a chatbot using the Mistral LLM."""
